...
const contractABI = require("../artifacts/contracts/Visiontransformer.sol/Visiontransformer.json").abi;

program
    .name("visiontransformer-cli")
    .description("CLI tool for Visiontransformer smart contract")
    .version("1.0.0");
